const CACHE='monikas-v22-ui-repair-1';
const APP_ASSETS=['./','./index.html','./manifest.json','./icon.svg','./backend-config.js','./sheet-sync.js','./monitoring.js','./ui-repair-v4.js'];
...
self.addEventListener('fetch',event=>{
 ...
 if(isPage){
  event.respondWith(fetch(event.request).then(async response=>{
   ...
   html=html.replace('</body>','<script src="./monitoring.js?v=22"></script><script src="./ui-repair-v4.js?v=22"></script></body>');
